...
import { clickHandler, ClickHandlerOptions } from "./clickHandler.js";
...
export interface LinkOptions {
   ...
   * @example false
   */
  openOnClick: boolean | ClickHandlerOptions["openOnClick"];
  /**
  ...
  addProseMirrorPlugins() {
    ...
    if(this.options.openOnClick) {
      plugins.push(
        clickHandler({
          type: this.type,
          openOnClick: typeof this.options.openOnClick === "function" ? this.options.openOnClick : () => true,
        }),
      );
    }
