...
>((props, ref) => {
  ...
  return (
    ...
    >
      <MantineMenu.Item
        className={bnClsx("bn-menu-item bn-mt-sub-menu-item")}
...
>((props, ref) => {
  ...
  return <MantineMenu.Divider className={bnClsx(className)} ref={ref} />;
});
...
>((props, ref) => {
  ...
  return (
    <MantineMenu.Label className={bnClsx(className)} ref={ref}>
      {children}
    </MantineMenu.Label>
  );
});
