...
export const AudioPreview = (
  props: Omit<
    ReactCustomBlockRenderProps<FileBlockConfig, any, any, any>,
    "contentRef"
  >,
) => {
...
export const AudioToExternalHTML = (
  props: Omit<
    ReactCustomBlockRenderProps<typeof audioBlockConfig, any, any, any>,
    "contentRef"
  >,
) => {
...
export const AudioBlock = (
  props: ReactCustomBlockRenderProps<typeof audioBlockConfig, any, any, any>,
) => {
  return (
    <FileBlockWrapper
      {...(props as any)}
